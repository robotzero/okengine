...
vulkan_swapchain_destroy :: proc(v_context: ^vulkan_context, swapchain: ^vulkan_swapchain) {
	destroy(v_context, swapchain)
}
...
create :: proc(v_context: ^vulkan_context, width: u32, height: u32, swapchain: ^vulkan_swapchain) {
	...
	if v_context.device.swapchain_support.capabilities.maxImageCount > 0 &&
	...
	swapchain_create_info.preTransform =
		v_context.device.swapchain_support.capabilities.currentTransform
